  ...
  <div class="main-inner">
    <div class="container">
     <div class="row">
		...
		//REQUISITOS
		$permite 	= array('image/jpeg', 'image/png', 'documentos/docx');
		$maxSize	= 1024 * 1024 * 5;
		...
		if($numFile <= 0){
			...
			$insert = "INSERT into tb_postagens1 (titulo, data, imagem, exibir, descricao) VALUES (:titulo, :data, :imagem, :exibir, :descricao)";
