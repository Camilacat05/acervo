            ...
            <div class="span12">	      		
                ...
                <div class="widget-header">
	      			...
	      			<div class="widget-content">	      				
                        ...
                        <?php
//RECUPERA OS DADOS
if(!isset($_GET['id'])){ header("Location: home.php?acao=ver-postagens1"); exit;}
$id = $_GET['id'];
$select = "SELECT * from tb_postagens1 WHERE id=:id";
$contagem =1;
		...
		//PASTA
		$folder		= '../sistema/upload/postagens/';
		...
		if($numFile <= 0){
			...
			for($i = 0; $i < $numFile; $i++){
				...
				if($error != 0)
					...
					if(move_uploaded_file($tmp, $folder.'/'.$novoNome)){
						...
						$arquivo = "../sistema/upload/postagens/" .$imagem;
						unlink($arquivo);
			...
			$update = "UPDATE tb_postagens1 SET titulo=:titulo, data=:data, imagem=:imagem, exibir=:exibir, descricao=:descricao WHERE id=:id";
