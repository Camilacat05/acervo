     ...
     <div class="row">
            ...
            <?php
               ...
               '<div class="alert alert-info">
                      ...
                      <strong>Olá, '.$nomeLogado.'!</strong> Seja Bem vindo ao <strong>Sistema de estudo do Integgle</strong> !
               </div>';
					}
				}
			 ?>  
            ...
            <div class="span12">	      		
	      		<div id="target-1" class="widget">
	      			<div class="widget-content">
			      		<h1>Acervo Digital - sujeitos, saberes e práticas tradicionais do semiárido.</h1>
			      		<p>O <strong>Acervo Digital</strong> é um Sistema de Postagem desenvolvido em conjunto com o Projeto de Extensão '<strong>, cujo objetivo é gerenciar toda parte de postagens e
