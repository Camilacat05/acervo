  ...
  <div class="main-inner">
    <div class="container">
     <div class="row">
        ...
        $caminhoDocumentos = '../upload/documentos/';
		...
		if($numFile <= 0){
            ...
            $nameDocumento = $documento['name'];
            $typeDocumento = $documento['type'];
            $sizeDocumento = $documento['size'];
            $errorDocumento = $documento['error'];
            $tmpDocumento = $documento['tmp_name'];
            $extensaoDocumento = @end(explode('.', $nameDocumento));
			$novoNomeDocumento = rand().".$extensaoDocumento";
            if(move_uploaded_file($tmpDocumento, $caminhoDocumentos.'/'.$novoNomeDocumento)){}

            $insert = "INSERT into tb_postagens (titulo, data, imagem, exibir, descricao, documento, categoria) VALUES (:titulo, :data, :imagem, :exibir, :descricao, :documento, :categoria)";
		...
		try{
            ...
            $result->bindParam(':documento', $novoNomeDocumento, PDO::PARAM_STR);
	 ...
	 ?>
                        ...
                        <div class="tab-pane" id="formcontrols">
								<form id="edit-profile" class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="control-group">
											<label class="control-label" for="lastname">Documento</label>
											<div class="controls">
												<input type="file" multiple class="span6 fileinput" id="documento" name="documento">
											</div> <!-- /controls -->
										</div> <!-- /control-group -->
                                         ...
                                         <div class="control-group">
											...
											<div class="controls">
											    <select name="categoria">
                                                  <option value="Artesanato" selected>Artesanato</option>
                                                  <option value="Palenda">Palendas</option>
                                                  <option value="Livros">Religiosidades</option>
                                                  <option value="Livros">Ofícios</option>
                                                  <option value="Livros">Culinária</option>
                                                  <option value="Livros">Música</option>
